        ...
        <Card className="card-security">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              The requested vault item could not be found or you don't have access to it.
            </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={handleToggleFavorite}>
            <Star className={`h-4 w-4 mr-2 ${item.favorite ? 'fill-current text-warning' : ''}`} />
          ...
          <Card className="card-security">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-foreground">{item.category || 'Uncategorized'}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground">{new Date(item.updatedAt).toLocaleString()}</p>
              </div>
